"""
Egyptian Arabic Text SER — The Stabilizer (v24)
==============================================
...
class StabilizerModel(nn.Module):
    def __init__(self, model_name="UBC-NLP/MARBERT", lora_r=16):
        ...
        lora_config = LoraConfig(r=lora_r, lora_alpha=lora_r*2, target_modules=["query", "value"], lora_dropout=0.1, bias="none")
    ...
    def forward(self, input_ids, attention_mask):
        ...
        combined = torch.cat([cls_token, mean_p, max_p], dim=1)
